...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Welcome to my wonderland.",
          section: "Navigation",
          handler: () => {
